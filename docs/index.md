...
<div class="traductions-grid">
    <div class="langue-group">
        ...
        <p>Langue officielle et définitions en français facile</p>
    </div>
    <div class="langue-group">
        <div class="language-label">🌍 Baoulé</div>
        <p>Langue Akan parlée au centre de la Côte d'Ivoire</p>
    </div>
    <div class="langue-group">
        <div class="language-label">🌍 Bété</div>
        <p>Langue Kru de l'ouest ivoirien</p>
    </div>
    <div class="langue-group">
        <div class="language-label">🌍 Lobi</div>
        <p>Langue Gur du nord-est</p>
    </div>
    <div class="langue-group">
        <div class="language-label">🌍 Malinké</div>
        <p>Langue Mandé du nord-ouest</p>
    </div>
    <div class="langue-group">
        <div class="language-label">🌍 Sénoufo</div>
        <p>Langue Gur du nord</p>
    </div>
    <div class="langue-group">
        <div class="language-label">🌍 Koulango</div>
        <p>Langue Gur de l'est</p>
    </div>
    <div class="langue-group">
        <div class="language-label">🌍 Yacouba</div>
        <p>Langue Mandé de l'ouest</p>
    </div>
</div>
...
<div class="terme-navigation">
    <p style="text-align: center; font-weight: bold; color: #2196F3; margin: 0;">
        🌍 Développé avec ❤️ par la SODEXAM - Côte d'Ivoire
    </p>
    <p style="text-align: center; color: #757575; margin: 0.5em 0 0 0;">
